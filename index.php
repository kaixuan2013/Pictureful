    ...
    <section id="pricing">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-md-4">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="600ms">
                        <ul class="pricing">
                            ...
                            <li>Up to <strong>100</strong> contributors</li>
                            <li><strong>Unlimited</strong> album</li>
                            <li><strong>Unlimited</strong> storage</li>
                            <li><strong>7</strong> days of live period</li>
                            <li>Filters</li>
                            <li>Live slideshow</li>
                            <li>Download album</li>
                            <li>Photo ranking</li>
                ...
                <div class="col-sm-8 col-md-4">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="800ms">
                        <ul class="pricing">
                            <li class="plan-header">
                                <div class="price-duration">
                                    <span class="price">
                            ...
                            <li>Up to <strong>Unlimited</strong> contributors</li>
                            <li><strong>Unlimited</strong> album</li>
                            <li><strong>Unlimited</strong> storage</li>
                            <li><strong>Indefinitely</strong> days of live period</li>
                            <li>Filters</li>
                            <li>Live slideshow</li>
                            <li>Download album</li>
                            <li>Photo ranking</li>
                ...
                <div class="col-sm-8 col-md-4">
                    <div class="wow zoomIn" data-wow-duration="400ms" data-wow-delay="1000ms">
                        <ul class="pricing">
                            <li class="plan-header">
                                <div class="price-duration">
                                    <span class="price">
                            ...
                            <li><strong>Tell us what you want!</strong></li>
                            <li>Specific needs?</li>
                            <li>Something not in the plans?</li>
                            <li>Per event or Month?</li>
                            <li>Some fun features?<li>
                            <li>We are flexible, just tell us!</li>
                            <li class="plan-purchase"><a class="btn btn-primary" href="#">Tell Us</a></li>
                        </ul>
                    </div>
                </div>
            </div>
